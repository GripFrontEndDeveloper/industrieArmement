...
<div class="col-md-12 sectNacReg">
    <div class="col-md-3 singleSecteur"><?php print $fields['field_entsecteur']->content ?></div>
...
<div class="col-md-12 singleCorps">
    ...
    <div class="col-md-7">
        <div class="col-md-12 singleCorps"><?php print $fields['field_filiales_entreprise']->content ?></div>
        <div class="col-md-12 dirigeantsCoordonnees">
            <div class="col-md-7 dirigeants"><?php print $fields['body']->content ?></div>
